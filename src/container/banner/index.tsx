...
export const Banner = () => {
	...
	return (
		<BannerWrapper>
			<Box component={"div"} className="banner-LHS">
				<img src={bannerImg} alt="caretimes-banner" />
			</Box>
			<Stack className="banner-RHS">
				<Stack gap={"calc(var(--flex-gap)/2)"}>
					<Box>
						...
						>
							Get the best of all our products in a full package tailored just
							for you alone at best prices and delivery to your doorstep or
							market place directly from our factory
						</Typography>
					</Box>
