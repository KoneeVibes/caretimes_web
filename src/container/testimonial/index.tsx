	...
	return (
		<TestimonialWrapper>
			...
			>
				{sets?.map((set, index) => {
					return (
						<Stack key={index} className="testimony-box">
							<Box
								...
								{set?.map((detail, index) => (
									<Stack
										...
										padding={{
											...
											laptop:
												index === 0
													? "calc(var(--basic-padding)/3) calc(var(--basic-padding)/3) calc(var(--basic-padding)/3) 0"
													: index === set.length - 1
														? "calc(var(--basic-padding)/3) 0 calc(var(--basic-padding)/3) calc(var(--basic-padding)/3)"
														: "calc(var(--basic-padding)/3)",
										}}
										borderLeft={{
											mobile: "2px solid var(--primary-color)",
											laptop:
												index !== 0 ? "2px solid var(--primary-color)" : "none",
										}}
									>
										<Box>
											<Typography
										...
										>
											<Stack gap={"calc(var(--flex-gap)/16)"}>
												<Typography
													variant="body1"
													fontFamily={"Inter"}
													fontWeight={600}
							...
							<Box component={"div"} className="leave-a-review-button-box">
								<BaseButton
									radius="64px"
									variant="outlined"
