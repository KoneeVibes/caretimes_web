...
export const Footer = () => {
	...
	const handleNewsletterRegistration = (
	...
	return (
		<FooterWrapper>
			<Stack className="footer-layer-one">
				<Stack
				...
				<Stack className="footer-layer-one-RHS">
					<Box>
						<Typography
							variant="subtitle1"
							fontFamily={"Cormorant"}
									...
									<BaseFieldSet>
										<BaseInput
											...
											sx={{
												...
												borderBottom:
													"1px solid var(--input-field-border-color)",
											}}
										/>
									</BaseFieldSet>
								</Box>
								<Box sx={{ display: "flex", overflow: "hidden" }}>
									<BaseButton disableElevation variant="contained">
										Submit
									</BaseButton>
								</Box>
							</form>
			...
			<Stack className="footer-layer-two">
				<Stack className="footer-layer-two-LHS">
